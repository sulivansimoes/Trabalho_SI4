			...
			if(buttonsPanel == null){
				...
				buttonsPanel.addButtonsListener(new ButtonsListenersCadastro() {
					...
					public void incluiPerformed() {
						JOptionPane.showMessageDialog(null, "Teste do botão incluir","AVISO",JOptionPane.YES_NO_CANCEL_OPTION);
						
					}

					@Override
					public void alteraPerformed() {
						JOptionPane.showMessageDialog(null, "Teste do botão alterar", "Alterar",JOptionPane.INFORMATION_MESSAGE);
